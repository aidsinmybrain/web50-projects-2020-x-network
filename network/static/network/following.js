document.addEventListener('DOMContentLoaded', function() {
    // By default, load all
    load_all();
    document.querySelector('#following_block').style = 'font:black; font-weight: bold; background-image: linear-gradient(to left, rgb(52, 164, 255), white);'
    document.querySelector('#following_link').style = 'color:grey; font-weight: bold;'
    // Comment click
